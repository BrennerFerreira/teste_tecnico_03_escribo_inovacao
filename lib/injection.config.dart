...
import 'modules/home/modules/characters/services/i_characters_services.dart'
    as _i4;
import 'modules/home/modules/movies/controllers/movies_bloc.dart' as _i12;
...
import 'shared/database/services/sqflite_database_services/sqflite_database_services.dart'
    as _i7;
import 'shared/favorites/controllers/favorites_bloc.dart' as _i11;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.FavoritesBloc>(
      () => _i11.FavoritesBloc(get<_i10.FavoritesServices>()));
  gh.factory<_i12.MoviesBloc>(() =>
      _i12.MoviesBloc(get<_i8.IMoviesServices>(), get<_i11.FavoritesBloc>()));
  gh.factory<_i13.CharactersBloc>(() => _i13.CharactersBloc(
      get<_i4.ICharactersServices>(), get<_i11.FavoritesBloc>()));
  return get;
}
